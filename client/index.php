    ...
    <div class="flex min-h-screen flex-col fade-in">
        <header class="flex items-center justify-between px-6 py-4 border-b fade-in bg-custom">
          <div class="flex items-center">
            ...
            <span class="text-lg font-semibold text-custom"> Cart</span>
          </div>
          <div class="flex items-center gap-4">
            <a href="login.php" class="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground ">
              <iconify-icon icon="mdi:login" class="mr-2"></iconify-icon> Log In
            </a>
            <a href="register.php" class="inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium ">
        ...
        <main class="flex-1 px-6 py-12 md:px-10 lg:px-16 fade-in">
          <div class="mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
              <h1 class="text-4xl font-bold tracking-tight text-primary fade-in">Streamline Your Business with Our Inventory Management System</h1>
              <p class="text-custom text-lg fade-in">
              Our powerful Inventory Management System helps you manage your stock, sales, and customer data with ease. Boost your efficiency and grow your business.
              </p>
